package com.nets.productorder.productline.config;

import com.nets.productorder.productline.filter.UserinfoInterceptor;
    ...
    */
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new UserinfoInterceptor())
                ...
                .excludePathPatterns("/heath/","/userinfo/login","/userinfo/init")
                /*
