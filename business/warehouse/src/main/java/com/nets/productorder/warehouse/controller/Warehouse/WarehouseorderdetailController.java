...
public class WarehouseorderdetailController extends ComPageSample {
    ...
    @GetMapping("/list")
    public ResultCode OnList(HttpServletRequest pRequest,Warehouseorderdetail tmpPojo) {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(HttpServletRequest pRequest,Warehouseorderdetail tmpPojo) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(HttpServletRequest pRequest,String ids,Warehouseorderdetail tmpPojo) {
        this.getTokenEntity(pRequest);
        this.sService.setTokenEntity(this.sTokenEntity);
