...
public class WarehousestockController extends ComPageSample {
    ...
    @GetMapping("/list")
    public ResultCode OnList(Warehousestock tmpPojo, Userinfo pAuth) {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(Warehousestock tmpPojo,Userinfo pAuth) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(String ids,Warehousestock tmpPojo,Userinfo pAuth) {
