...
public class WarehouseorderController extends ComPageSample {
    ...
    @GetMapping("/list")
    public ResultCode OnList(Warehouseorder tmpPojo, Userinfo pAuth) {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(Warehouseorder tmpPojo,Userinfo pAuth) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(String ids,Warehouseorder tmpPojo,Userinfo pAuth) {
