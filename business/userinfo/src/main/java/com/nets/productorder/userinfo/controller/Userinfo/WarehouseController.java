...
public class WarehouseController extends ComPageSample {
    ...
    @GetMapping("/list")
    public ResultCode OnList(Warehouse tmpPojo, Userinfo pAuth) {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(Warehouse tmpPojo,Userinfo pAuth) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(String ids,Warehouse tmpPojo,Userinfo pAuth) {
