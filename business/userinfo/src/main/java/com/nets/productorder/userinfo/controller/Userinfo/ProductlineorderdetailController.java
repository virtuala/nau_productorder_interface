...
public class ProductlineorderdetailController extends ComPageSample {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(Productlineorderdetail tmpPojo,Userinfo pAuth) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(String ids,Productlineorderdetail tmpPojo,Userinfo pAuth) {
    ...
    public ResultCode OnComplete(String pId,Userinfo pAuth) {
