...
public class ProductlineController extends ComPageSample {
    ...
    @PostMapping("/add")
    public ResultCode OnAdd(Productline tmpPojo,Userinfo pAuth) {
    ...
    @PostMapping("/modify")
    public ResultCode OnModify(String ids,Productline tmpPojo,Userinfo pAuth) {
    ...
    public ResultCode searchWithProductlineorderdetail(Userinfo pAuth) {
